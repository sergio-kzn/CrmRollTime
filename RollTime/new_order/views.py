...
from .services import prepare_context_for_html, create_new_order, create_new_order_number
...
def new_order(request):
    ...
    if request.method == 'POST':
        ...
        form = NewOrderForm(auto_id=False, initial={'order_number': create_new_order_number()})
